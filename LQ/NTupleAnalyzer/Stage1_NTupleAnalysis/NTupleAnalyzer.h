...
fChain->SetBranchStatus("CaloJetEta",0);
...
fChain->SetBranchStatus("CaloJetPhi",0);
fChain->SetBranchStatus("CaloJetPt",0);
...
fChain->SetBranchStatus("CaloJetTrackCountingHighEffBTag",0);
...
fChain->SetBranchStatus("PFJetPassLooseID",1);
fChain->SetBranchStatus("PFJetPassTightID",1);
