...
////
////
////   input:  expected background                                   -  amub 
////           signal = observed value  (Nobs)
////                                  - expected background (amub)   -  amus 
////           
////           expected or/and observed rms (sigma_b) of 
////                statistical uncertainties in background          -  sigmab
//// {The sigmab**2 is variance of the error in determination 
////  of amub only. If you know parameter amub without error, 
////  then sigma2 must be zero. The stochastic behaviour of background
////  is taken into account inside algorithms.}
////
////           expected systematics of theoretical 
////                          origin in background                   -  deltab
////
////   output:  significance S_cP, calculated by formula     -  dsgnf
////            significance S_cP, calculated by Monte Carlo -  dsgnfm
////

double scp(double sig, double bkg, double sigma_b, double delta_b)

{
double fac2  = sqrt(bkg+delta_b)/sqrt(bkg+sigma_b**2+delta_b);
