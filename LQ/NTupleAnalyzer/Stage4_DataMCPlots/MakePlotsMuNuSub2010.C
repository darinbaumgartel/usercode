...
//			if (ndat==0) h_comp ->SetBinContent(ibin,999 );
		}
...
//	  fillHisto(cut_mc, cut_data, true, 4000,0,4000, "MT_muon1pfMET", false, "","M^{T}_{#mu#nu}(GeV) " +xtag,lumi,10,WNormalization,filetag);
	...
	gROOT->Reset(); gROOT->ProcessLine(".x LoadLocal.C");
	fillHisto(cut_mc, cut_data ,true,10,.-.5,9.5, "N_Vertices", false, "","N_{Vertices} " +xtag,lumi,10000,WNormalization,filetag);

	gROOT->Reset(); gROOT->ProcessLine(".x LoadLocal.C");
	fillHisto(cut_mc, cut_data ,true,10,.-.5,9.5, "PFJetCount", false, "","N_{pfJet} " +xtag,lumi,10000,WNormalization,filetag);


	gROOT->Reset(); gROOT->ProcessLine(".x LoadLocal.C");
	fillHisto(cut_mc, cut_data ,true,10,.-.5,9.5, "BpfJetCount", false, "","N_{BJet} " +xtag,lumi,10000,WNormalization,filetag);
	...
	gROOT->Reset(); gROOT->ProcessLine(".x LoadLocal.C");
	fillHisto(cut_mc, cut_data, true, 80,0,400, "Pt_pfjet1", false, "","p_{T} (jet_{1}) (GeV) " +xtag,lumi,10,WNormalization,filetag);

	gROOT->Reset(); gROOT->ProcessLine(".x LoadLocal.C");
	fillHisto(cut_mc, cut_data, true, 80,0,400, "Pt_pfjet2", false, "","p_{T} (jet_{2}) (GeV) " +xtag,lumi,10,WNormalization,filetag);
	...
	fillHisto(cut_mc, cut_data, true, 40,0,800, "M_bestmupfjet_munu", false, "","M_{#mu jet} " +xtag,lumi,100,WNormalization,filetag);
		...
		gROOT->Reset();	gROOT->ProcessLine(".x LoadLocal.C");
	  fillHisto(cut_mc, cut_data, true, 32,-3.15,3.15, "deltaPhi_pfjet1pfMET", false, "","#Delta#phi (j_{1},E_{T}^{miss}) " +xtag,lumi,100,WNormalization,filetag);

		gROOT->Reset();	gROOT->ProcessLine(".x LoadLocal.C");
	  fillHisto(cut_mc, cut_data, true, 32,-3.15,3.15, "deltaPhi_pfjet2pfMET", false, "","#Delta#phi (j_{2},E_{T}^{miss}) " +xtag,lumi,100,WNormalization,filetag);
	  
	  		gROOT->Reset();	gROOT->ProcessLine(".x LoadLocal.C");
	  fillHisto(cut_mc, cut_data, true, 32,-3.15,3.15, "deltaPhi_muon1pfjet1", false, "","#Delta#phi (#mu,j_{1}) " +xtag,lumi,100,WNormalization,filetag);

		gROOT->Reset();	gROOT->ProcessLine(".x LoadLocal.C");
	  fillHisto(cut_mc, cut_data, true, 32,-3.15,3.15, "deltaPhi_muon1pfjet2", false, "","#Delta#phi (#mu,j_{2}) " +xtag,lumi,100,WNormalization,filetag);

		gROOT->Reset();	gROOT->ProcessLine(".x LoadLocal.C");
	  fillHisto(cut_mc, cut_data, true, 60,0,6, "deltaR_muon1pfjet1", false, "","#Delta R (#mu, j_{1}) " +xtag,lumi,100,WNormalization,filetag);

		gROOT->Reset();	gROOT->ProcessLine(".x LoadLocal.C");
	  fillHisto(cut_mc, cut_data, true, 60,0,6, "deltaR_muon1pfjet2", false, "","#Delta R (#mu, j_{2}) " +xtag,lumi,100,WNormalization,filetag);
