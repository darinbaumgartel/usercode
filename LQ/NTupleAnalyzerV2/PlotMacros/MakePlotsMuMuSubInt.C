	       ...
	       int nBins, float xLow, float xMax, TString var, TString var_emu, bool Use_integral, TString fileName,TString title, TString Luminosity,Double_t extrascalefactor,Double_t znorm,TString tag)
{
	...
	c1->Print("PlotsMuMuSubInt/"+varname+"_"+tag+".png");
	c1->Print("PlotsMuMuSubInt/"+varname+"_"+tag+".pdf");
...
void MakePlotsMuMuSubInt()
{
	...
	cut_data += "*(HLTMu40TriggerPass>0.5)";
	cut_data_emu += "*(HLTMu40TriggerPass>0.5)";

	float ZNormalization = 1.29;
	TString filetag = " ";
	TString xtag = " ";
	...
	//gROOT->Reset();	gROOT->ProcessLine(".q;");	
	Use_emu = true;
	fillHisto(lq_choice, cut_mc, cut_data, cut_data_emu, Use_emu, true, 50,0,500, "MET_pf", "MET_pf",        use_integral, "","E_{T}^{miss}(GeV) " +xtag  ,lumi,50,ZNormalization,filetag);
	...
	fillHisto(lq_choice, cut_mc, cut_data, cut_data_emu, Use_emu, true,40,.-.5,39.5, "N_Vertices", "N_Vertices", use_integral, "","N_{Vertices} " +xtag,lumi,500,ZNormalization,filetag);
	...
	//fillHisto(lq_choice, cut_mc, cut_data, cut_data_emu, Use_emu, true, 63,-3.15,3.15, "deltaPhi_muon1pfjet1", "deltaPhi_muon1pfjet1", use_integral, "","#Delta#phi (#mu_{1}, j_{1}) " +xtag,lumi,100,ZNormalization,filetag);
	//fillHisto(lq_choice, cut_mc, cut_data, cut_data_emu, Use_emu, true, 63,-3.15,3.15, "deltaPhi_muon1pfjet2", "deltaPhi_muon1pfjet2", use_integral, "","#Delta#phi (#mu_{1}, j_{2}) " +xtag,lumi,100,ZNormalization,filetag);
	//fillHisto(lq_choice, cut_mc, cut_data, cut_data_emu, Use_emu, true, 63,-3.15,3.15, "deltaPhi_muon2pfjet1", "deltaPhi_muon2pfjet1", use_integral, "","#Delta#phi (#mu_{2}, j_{1}) " +xtag,lumi,100,ZNormalization,filetag);
	//fillHisto(lq_choice, cut_mc, cut_data, cut_data_emu, Use_emu, true, 63,-3.15,3.15, "deltaPhi_muon2pfjet2", "deltaPhi_muon2pfjet2", use_integral, "","#Delta#phi (#mu_{2}, j_{2}) " +xtag,lumi,100,ZNormalization,filetag);
	//fillHisto(lq_choice, cut_mc, cut_data, cut_data_emu, Use_emu, true, 60,0,6, "deltaR_muon1pfjet1", "deltaR_muon1pfjet1", use_integral, "","#Delta R (#mu_{1}, j_{1}) " +xtag,lumi,100,ZNormalization,filetag);
	//fillHisto(lq_choice, cut_mc, cut_data, cut_data_emu, Use_emu, true, 60,0,6, "deltaR_muon1pfjet2", "deltaR_muon1pfjet2", use_integral, "","#Delta R (#mu_{1}, j_{2}) " +xtag,lumi,100,ZNormalization,filetag);
	//fillHisto(lq_choice, cut_mc, cut_data, cut_data_emu, Use_emu, true, 60,0,6, "deltaR_muon2pfjet1", "deltaR_muon2pfjet1", use_integral, "","#Delta R (#mu_{2}, j_{1}) " +xtag,lumi,100,ZNormalization,filetag);
	//fillHisto(lq_choice, cut_mc, cut_data, cut_data_emu, Use_emu, true, 60,0,6, "deltaR_muon2pfjet2", "deltaR_muon2pfjet2", use_integral, "","#Delta R (#mu_{2}, j_{2}) " +xtag,lumi,100,ZNormalization,filetag);
	...
	//fillHisto(lq_choice, cut_mc, cut_data, cut_data_emu, Use_emu, true, 40,0,800, "M_pfjet1pfjet2", "M_pfjet1pfjet2", use_integral, "","M_{jj}(GeV)" +xtag,lumi,10,ZNormalization,filetag);
	...
	//fillHisto(lq_choice, cut_mc, cut_data, cut_data_emu, Use_emu, true, 40,0,8, "deltaR_pfjet1pfjet2", "deltaR_pfjet1pfjet2", use_integral, "","#Delta R (j_{1}j_{2})(GeV)" +xtag,lumi,1000,ZNormalization,filetag);
	//fillHisto(lq_choice, cut_mc, cut_data, cut_data_emu, Use_emu, true, 40,-3.15,3.15, "deltaPhi_pfjet1pfjet2", "deltaPhi_pfjet1pfjet2", use_integral, "","#Delta#phi (j_{1}j_{2})(GeV)" +xtag,lumi,1000,ZNormalization,filetag);
	...
	fillHisto(lq_choice, cut_full_mc, cut_full_data,cut_full_data_emu,  Use_emu, use_integral, 25,0.0,2000.0, "M_bestmupfjet1_mumu", "M_bestmuORelepfjet1_mumu_emuselection", use_integral, "","M_{#mu j} " +xtag,lumi,500,ZNormalization,filetag);
	fillHisto(lq_choice, cut_full_mc, cut_full_data,cut_full_data_emu, Use_emu, use_integral, 25,250,1750, "ST_pf_mumu", "ST_pf_emu", use_integral, "","S_{T} (GeV)" +xtag,lumi,500,ZNormalization,filetag);
	fillHisto(lq_choice, cut_full_mc, cut_full_data,cut_full_data_emu, false , use_integral, 60,900,9000, "M_muon1muon2pfjet1pfjet2", "M_muon1muon2pfjet1pfjet2", use_integral, "","M_{#mu#mujj} (GeV)" +xtag,lumi,500,ZNormalization,filetag);
	...
	fillHisto(lq_choice, cut_full_mc, cut_full_data,cut_full_data_emu,  Use_emu, use_integral, 25,0.0,2000.0, "M_bestmupfjet1_mumu", "M_bestmuORelepfjet1_mumu_emuselection", use_integral, "","M_{#mu j} " +xtag,lumi,500,ZNormalization,filetag);
	fillHisto(lq_choice, cut_full_mc, cut_full_data,cut_full_data_emu, Use_emu, use_integral, 25,250,1750, "ST_pf_mumu", "ST_pf_emu", use_integral, "","S_{T} (GeV)" +xtag,lumi,500,ZNormalization,filetag);
	fillHisto(lq_choice, cut_full_mc, cut_full_data,cut_full_data_emu, false , use_integral, 30,0,3000, "M_muon1muon2pfjet1pfjet2", "M_muon1muon2pfjet1pfjet2", use_integral, "","M_{#mu#mujj} (GeV)" +xtag,lumi,500,ZNormalization,filetag);
