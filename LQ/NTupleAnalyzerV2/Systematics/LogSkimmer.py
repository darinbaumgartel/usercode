...
for B in Backgrounds:
	...
	for S in Lqsignals:
		...
		if i_StandardSelections != 0:
			rate = i_StandardSelections
			rateerr = 1.0+(ie_StandardSelections/i_StandardSelections)			
			jes = 1.0+abs(i_JetScaleDown - i_StandardSelections)/i_StandardSelections		
			if (i_JetScaleUp>i_JetScaleDown):
				jes = 1.0+ abs(i_JetScaleUp - i_StandardSelections)/i_StandardSelections
			mes = abs(i_MuScaleDown - i_StandardSelections)/i_StandardSelections		
			if (i_MuScaleUp>i_MuScaleDown):
				mes = 1.0+abs(i_MuScaleUp - i_StandardSelections)/i_StandardSelections		
			jres = 1.0+abs(i_JetSmear - i_StandardSelections)/i_StandardSelections		
			mres = 1.0+abs(i_MuSmear - i_StandardSelections)/i_StandardSelections
