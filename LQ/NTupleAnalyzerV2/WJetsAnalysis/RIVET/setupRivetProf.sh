...
source /afs/cern.ch/sw/lcg/external/MCGenerators_hepmc2.06/rivet/1.8.0/$LCGTAG/rivetenv.sh
source /afs/cern.ch/sw/lcg/external/MCGenerators_hepmc2.06/agile/1.4.0/$LCGTAG/agileenv.sh
