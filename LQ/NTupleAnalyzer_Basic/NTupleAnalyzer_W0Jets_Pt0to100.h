...
#ifndef NTupleAnalyzer_W0Jets_Pt0to100_h
#define NTupleAnalyzer_W0Jets_Pt0to100_h
...
#include <iostream>
#include <TH1F.h>
class NTupleAnalyzer_W0Jets_Pt0to100 {
public :
   ...
   NTupleAnalyzer_W0Jets_Pt0to100(TTree *tree=0);
   virtual ~NTupleAnalyzer_W0Jets_Pt0to100();
...
#ifdef NTupleAnalyzer_W0Jets_Pt0to100_cxx
NTupleAnalyzer_W0Jets_Pt0to100::NTupleAnalyzer_W0Jets_Pt0to100(TTree *tree)
...
chain->Add("/home/darinb/scratch0/LQ/data_7TeV/FULLSIM_Summer2010_V2/Backgrounds_MC/W0Jets_Pt0to100/W0Jets_Pt0to100-alpgen__Spring10-START3X_V26_S09-v1.root");
...
NTupleAnalyzer_W0Jets_Pt0to100::~NTupleAnalyzer_W0Jets_Pt0to100()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t NTupleAnalyzer_W0Jets_Pt0to100::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NTupleAnalyzer_W0Jets_Pt0to100::LoadTree(Long64_t entry)
{
...
void NTupleAnalyzer_W0Jets_Pt0to100::Init(TTree *tree)
{
...
fChain->SetBranchStatus("CaloJetEMF",1);
...
fChain->SetBranchStatus("CaloJetfHPD",1);
...
fChain->SetBranchStatus("MuonEcalIso",0);
...
fChain->SetBranchStatus("MuonHcalIso",0);
...
fChain->SetBranchStatus("MuonTrkIso",0);
fChain->SetBranchStatus("MuonVtxDistXY",0);
fChain->SetBranchStatus("MuonVtxDistZ",0);
fChain->SetBranchStatus("PFJetChargedEmEnergyFraction",1);
fChain->SetBranchStatus("PFJetChargedHadronEnergyFraction",1);
fChain->SetBranchStatus("PFJetChargedMuEnergyFraction",0);
fChain->SetBranchStatus("PFJetElectronEnergyFraction",0);
fChain->SetBranchStatus("PFJetEnergy",1);
...
fChain->SetBranchStatus("PFJetNeutralEmEnergyFraction",1);
fChain->SetBranchStatus("PFJetNeutralHadronEnergyFraction",1);
...
fChain->SetBranchStatus("PFJetTrackCountingHighEffBTag",1);
...
fChain->SetBranchStatus("TCMET",1);
fChain->SetBranchStatus("TCMETPhi",1);
...
fChain->SetBranchStatus("CaloJetOverlaps",1);
fChain->SetBranchStatus("CaloJetPartonFlavour",0);
fChain->SetBranchStatus("CaloJetPassLooseID",0);
fChain->SetBranchStatus("CaloJetPassTightID",0);
fChain->SetBranchStatus("CaloJetn90Hits",1);
...
fChain->SetBranchStatus("PFJetChargedMultiplicity",1);
...
fChain->SetBranchStatus("PFJetNeutralMultiplicity",1);
...
Bool_t NTupleAnalyzer_W0Jets_Pt0to100::Notify()
{
...
void NTupleAnalyzer_W0Jets_Pt0to100::Show(Long64_t entry)
{
...
Int_t NTupleAnalyzer_W0Jets_Pt0to100::Cut(Long64_t entry)
{
...
#endif // #ifdef NTupleAnalyzer_W0Jets_Pt0to100_cxx
