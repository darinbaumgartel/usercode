...
void datahisto( TString varname, TString version, TString currentcut, int bins, float low,float high, TString xlabel)
{
	...
	c1->Print("plots_v2/gaus/data"+varname+"_"+version+".png");
}
...
void zmchisto( TString varname, TString version, TString currentcut, int bins, float low,float high, TString xlabel)
{
	...
	thishisto->Fit("gaus");
	thishisto->GetXaxis()->SetTitle(xlabel);
	c1->Print("plots_v2/gaus/zmc"+varname+"_"+version+".png");
}
...
void wmchisto( TString varname, TString version, TString currentcut, int bins, float low,float high, TString xlabel)
{
	...
	thishisto->Fit("gaus");
	thishisto->GetXaxis()->SetTitle(xlabel);
	c1->Print("plots_v2/gaus/wmc"+varname+"_"+version+".png");
}
...
//     std::cout<<"&&&&&&&&&&&&&&&&&&&&   "<<wjets->GetEntries("weight*36.1*"+cutstring+"&&"+ cut_data_w)<<std::endl;
	...
	std::ofstream file("RecoilBinLog_v2.txt");
  ...
  // Just Z and Data
	...
	std::cout<<"\n\n#################       Fit:: U1 Data       ################\n\n"<<std::endl;
	GR_data_u1->Fit("pol2");	std::cout<<"****************************"<<std::endl;
	GR_data_u1->GetFunction("pol2")->SetLineColor(1);
	GR_data_u1->GetFunction("pol2")->SetLineWidth(2);
	std::cout<<"\n\n#################       Fit:: U1 Z MC       ################\n\n"<<std::endl;
	GR_zmc_u1->Fit("pol2");	std::cout<<"****************************"<<std::endl;
	GR_zmc_u1->GetFunction("pol2")->SetLineColor(2);
	GR_zmc_u1->GetFunction("pol2")->SetLineWidth(2);
	c_u1->Print("plots_v2/fits/U1_Z_mean.png");
	...
	std::cout<<"\n\n#################       Fit:: U2 Data       ################\n\n"<<std::endl;
	GR_data_u2->Fit("pol2");	std::cout<<"****************************"<<std::endl;
	GR_data_u2->GetFunction("pol2")->SetLineColor(1);
	GR_data_u2->GetFunction("pol2")->SetLineWidth(2);
	std::cout<<"\n\n#################       Fit:: U2 Z MC       ################\n\n"<<std::endl;
	GR_zmc_u2->Fit("pol2");	std::cout<<"****************************"<<std::endl;
	GR_zmc_u2->GetFunction("pol2")->SetLineColor(2);
	GR_zmc_u2->GetFunction("pol2")->SetLineWidth(2);
	...
	c_u2->Print("plots_v2/fits/U2_Z_mean.png");
	...
	c_rms_u1->Print("plots_v2/fits/U1_Z_rms.png");
	...
	c_rms_u2->Print("plots_v2/fits/U2_Z_rms.png");
  ...
  // Z and W and Data
	...
	GRw__data_u1->GetHistogram()->SetMinimum(-350);
	TCanvas *cw_u1 = new TCanvas("c_u1");
	std::cout<<"\n\n#################       Fit:: U1  Data       ################\n\n"<<std::endl;
	GRw__data_u1->Fit("pol2");	std::cout<<"****************************"<<std::endl;
	GRw__data_u1->GetFunction("pol2")->SetLineColor(1);
	GRw__data_u1->GetFunction("pol2")->SetLineWidth(2);
	std::cout<<"\n\n#################       Fit:: U1  W MC       ################\n\n"<<std::endl;
	GRw__wmc_u1->Fit("pol2");	std::cout<<"****************************"<<std::endl;
	GRw__wmc_u1->GetFunction("pol2")->SetLineColor(4);
	GRw__wmc_u1->GetFunction("pol2")->SetLineWidth(2);
 ...
 GRw__wmc_u1->SetName("GRw__wmc_u1");
  ...
  l->Draw("same");
	...
	cw_u1->Print("plots_v2/fits/U1_W_.png");
	...
	GRw__data_u2->GetHistogram()->SetMaximum(10);
	GRw__data_u2->GetHistogram()->SetMinimum(-10);
	TCanvas *cw_u2 = new TCanvas("c_u2");
	std::cout<<"\n\n#################       Fit:: U2  Data       ################\n\n"<<std::endl;
	GRw__data_u2->Fit("pol2");	std::cout<<"****************************"<<std::endl;
	GRw__data_u2->GetFunction("pol2")->SetLineColor(1);
	GRw__data_u2->GetFunction("pol2")->SetLineWidth(2);
	std::cout<<"\n\n#################       Fit:: U2  W MC       ################\n\n"<<std::endl;
	GRw__wmc_u2->Fit("pol2");	std::cout<<"****************************"<<std::endl;
	GRw__wmc_u2->GetFunction("pol2")->SetLineColor(4);
	GRw__wmc_u2->GetFunction("pol2")->SetLineWidth(2);
  ...
  l->Draw("same");
	cw_u2->Print("plots_v2/fits/U2_W_.png");
	...
	GRw_rms__data_u1->GetHistogram()->SetMaximum(250);
  ...
  l->Draw("same");
	cw_rms_u1->Print("plots_v2/fits/U1_W_rms.png");
	...
	GRw_rms__data_u2->GetHistogram()->SetMaximum(40);
  ...
  l->Draw("same");
	cw_rms_u2->Print("plots_v2/fits/U2_W_rms.png");
