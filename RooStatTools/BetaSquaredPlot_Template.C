...
void makePlots()
{
 ...
 string fileName2 = "BetaSquaredSigmaPlot.pdf";
...
//  pl->SetFillStyle(3001);
 ...
 TGraph *exshade1 = new TGraph(numbershade,x_shademasses,y_1sigma);
 exshade1->SetFillColor(kCyan);
 TGraph *exshade2 = new TGraph(numbershade,x_shademasses,y_2sigma);
